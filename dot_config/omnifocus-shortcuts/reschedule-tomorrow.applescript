-- Reschedule the selected OmniFocus item(s) due date to tomorrow, keeping
-- their existing time-of-day (or defaulting to 5pm for items with no
-- due date yet). Triggered by the F14 key; see dot_config/skhd/skhdrc.

set targetDate to my dateAtOffset(1)
